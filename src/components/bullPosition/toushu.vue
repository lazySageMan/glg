<template>
    <div>
        <div type="text" @click="dialogFormVisible = true">投诉订单</div>
        ...
        >
            ...
            <div class="toushuYuan" style="margin-bottom:6px;">
                <h3 style="margin-bottom:6px;">投诉原因：</h3>
            ...
            <div class="toushuContent" style="margin-bottom:6px;">
                <h3 style="margin-bottom:6px;">投诉内容：</h3>
                <el-input
                    type="textarea"
                    :rows="2"
...
export default {
    ...
    methods:{
        toushu(){
            ...
            if(this.textarea && this.radio && this.sendAddress){
                this.$http.post("https://api.guligou.com/api/OrderComplains/saveComplain.html",qs.stringify({
                    token:this.userInfo.userInfo.toKen,
                    orderId:this.orderId,
                    complainAnnex:this.sendAddress,
                    complainContent:this.textarea,
                    complainType:this.radio
                }))
                .then((data) =>{
