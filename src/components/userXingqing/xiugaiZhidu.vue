  ...
  <div>
    <div @click="dialogFormVisible = true" style="font-family:'youYuan'">
        <div  class=" glg-user-zhanghushezhixia">
            <a href="javascript:;" style=" margin-left:5%">支付密码</a>
    ...
    >
        <el-form 
            ...
            label-width="0" 
            class="demo-ruleForm"
            v-if="userInfo.userInfo.payPwd != 1"
        >
            <el-form-item label="" prop="pass">
                <el-input type="password" placeholder="设置支付密码" v-model="ruleForm2.pass" auto-complete="off"></el-input>
            </el-form-item>
            <el-form-item label="" prop="checkPass">
                <el-input type="password" placeholder="确认支付密码" v-model="ruleForm2.checkPass" auto-complete="off"></el-input>
            </el-form-item>
        </el-form>
...
export default {
  ...
  methods:{
      submitForm(formName) {
        ...
        if(this.userInfo.userInfo.payPwd == 1){
            this.$http.post("https://api.guligou.com/api/users/payPassEdit",qs.stringify({
            ...
            .then((data) => {
                if(data.data.status == 1){
                    this.dialogFormVisible = false;
                    this.userInfo.userInfo.payPwd = 1;
                    this.$notify({
                        type: 'success',
                        title:'成功提醒',
                        message:data.data.msg,
